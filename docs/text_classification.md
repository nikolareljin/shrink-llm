...
([ScamSeal](https://github.com/nikolareljin/scam-seal): an on-device scam detector that runs a
...
were found by reading ScamSeal's runtime against MobileBERT's input signature; the full analysis
